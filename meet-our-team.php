...
<!-- grid -->
  ...
  <div class="item">
      <a href="listings-agents.php?agentName=<?php echo $row_Recordset1['photoTitle']; ?>"><div class="overlay-item">
        ...
        <?php if ($row_Recordset1['file_name']!=''){ ?>
        <img style="width:300px; height:400px;" src="http://4siteusa.com/uploads/<?php echo $row_Recordset1['file_name']; ?>">
        <?php } else { ?>
        <img src="http://4siteusa.com/uploads/comingsoon.jpg">
        <?php } ?>
        </div>
        <?php if ($row_Recordset1['photoTitle'] != '' || $row_Recordset1['photoTitle'] != NULL){ ?>
